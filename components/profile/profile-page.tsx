...
import { User, Mail, Lock, Clock, Eye, EyeOff, CheckCircle2, AlertCircle, Camera, Shield } from "lucide-react"
import { Button } from "@/components/ui/button"
import { cn } from "@/lib/utils"
import { useApp, formatBytes } from "@/lib/store"

type ProfileTab = "info" | "history" | "security"

export function ProfilePage() {
  const { currentUser, updateUser, activityLogs, openAuthModal } = useApp()
